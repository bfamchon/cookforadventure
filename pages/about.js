    ...
    return (
        <>
            ...
            <Section id="made-for-you" title="Fait pour vous">
                <SectionParagraph>Si tu es arrivé sur Cook For Adventure, c’est que nous avons déjà plein de choses en commun. On aime l’aventure, on aime les bons plats, les plats rapides à préparer et on s’intéresse aux apports de ce que l’on consomme pour le sport.</SectionParagraph>
                <SectionParagraph>Ça tombe bien : je te présente ici des <Link href={'/nutrition'}><a aria-label="recettes">recettes simples</a></Link>, des recettes enrichies d’informations nutritionnelles, des recettes que j’ai testées personnellement sur mes <Link href={'/recits-aventures'}><a aria-label="récits d'aventure">randonnées et trails en autosuffisance.</a></Link> Et si tu te demandes comment cuisiner, transporter tes vivres quand tu pars à l'aventure, ou encore quels <strong>aliments vraiment intéréssants</strong> emporter avec toi, les <Link href={'/tests-produits-sportifs'}><a aria-label="tests de produits">tests de produits</a></Link> répondront à tes attentes !</SectionParagraph>
